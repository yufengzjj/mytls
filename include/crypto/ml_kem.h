...
/*
 * Upstream keys these off NID_ML_KEM_*, which this branch has no object
 * identifiers for: ML-KEM is only reachable here through the TLS
 * X25519MLKEM768 group, never as an EVP_PKEY algorithm. The values just have
 * to be distinct - ossl_ml_kem_get_vinfo() is the only consumer.
 */
#define EVP_PKEY_ML_KEM_512 0x4b454d02 /* "KEM" + rank */
#define EVP_PKEY_ML_KEM_768 0x4b454d03
#define EVP_PKEY_ML_KEM_1024 0x4b454d04
